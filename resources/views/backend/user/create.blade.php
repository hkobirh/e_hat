    ...
    <div class="row pt-2 pb-2">
        ...
        <div class="col-sm-3">
            <div class="btn-group float-sm-right">
                <a href="{{ route('staff.users.index') }}" type="button" class="btn btn-primary waves-effect waves-light"><i
                        class="fa fa-plus-circle mr-1"></i> Manage user</a>
            </div>
        </div>
    </div>
    <div class="row">
        <div class="col-lg-8 offset-2">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <hr>
                    <form action="{{ route('staff.users.store') }}" method="POST" class="user-create"
                        ...
                        <div class="form-group">
                            ...
                            <input type="mobile" value="{{ old('mobile') }}" class="form-control" id="mobile"
