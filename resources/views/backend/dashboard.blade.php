                ...
                <div class="table-responsive">
                    <table class="table align-items-center table-flush">
                        ...
                        <tbody>
                            <tr>
                                <td>
                                    <img alt="Image placeholder" src="{{ asset('backend/assets/images/products/01.png') }}"
                                        class="product-img">
                                </td>
                                <td>Headphone GL</td>
                                <td>$1,840 USD</td>
                            ...
                            <tr>
                                <td>
                                    <img alt="Image placeholder" src="{{ asset('backend/assets/images/products/02.png') }}"
                                        class="product-img">
                                </td>
                                <td>Clasic Shoes</td>
                                <td>$1,520 USD</td>
                            ...
                            <tr>
                                <td>
                                    <img alt="Image placeholder" src="{{ asset('backend/assets/images/products/03.png') }}"
                                        class="product-img">
                                </td>
                                <td>Hand Watch</td>
                                <td>$1,620 USD</td>
                            ...
                            <tr>
                                <td>
                                    <img alt="Image placeholder" src="{{ asset('backend/assets/images/products/04.png') }}"
                                        class="product-img">
                                </td>
                                <td>Hand Camera</td>
                                <td>$2,220 USD</td>
                            ...
                            <tr>
                                <td>
                                    <img alt="Image placeholder" src="{{ asset('backend/assets/images/products/05.png') }}"
                                        class="product-img">
                                </td>
                                <td>Iphone-X Pro</td>
                                <td>$9,890 USD</td>
                            ...
                            <tr>
                                <td>
                                    <img alt="Image placeholder" src="{{ asset('backend/assets/images/products/06.png') }}"
                                        class="product-img">
                                </td>
                                <td>Ladies Purse</td>
                                <td>$3,420 USD</td>
