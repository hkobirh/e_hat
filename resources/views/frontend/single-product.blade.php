                                    ...
                                    <div class="product-thumbs row cols-4 gutter-sm">
                                        @foreach (json_decode($product->gallery) as $image)
                                            <div class="product-thumb active">
                                                <img src="{{ $image }}" alt="Product Thumb" width="800" height="900">
                                            </div>
                                        @endforeach
                                    </div>
                        ...
                        <div class="col-md-6 mb-4 mb-md-6">
                            <div class="product-details" data-sticky-options="{'minWidth': 767}">
                                ...
                                <div class="product-bm-wrapper">
                                    <figure class="brand">
                                        <img src="{{asset('assets/images/products/brand/').$product->brand->thumbnail}}"
                                             alt="Brand" width="102" :
                                             height="48"/>
                                    </figure>
                                ...
                                <div class="fix-bottom product-sticky-content sticky-content">
                                    <div class="product-form container">
                                        ...
                                        <a class="btn btn-primary btn-cart" href="{{ route('cart.store') }}"
                                           data-slug="{{ $product->slug }}" id="add-to-cart">
                                    ...
                                    <div class="col-xl-4 col-lg-5 mb-4">
                                        <div class="ratings-wrapper">
                                            <div class="avg-rating-container">
                                                <h4 class="avg-mark font-weight-bolder ls-50">{{round($reviews->avg('rating'),2)}}</h4>
                                            ...
                                            <div class="ratings-value d-flex align-items-center text-dark ls-25">
                                                <span class="text-dark font-weight-bold">{{round($reviews->avg('rating')*20,2)}}%</span>Recommended<span
                                                ...
                                                <div class="review-form-wrapper">
                                                    ...
                                                    <form action="{{route('product.review')}}" method="POST" class="review-form">
                                                        ...
                                                        <textarea cols="30" rows="6" placeholder="Write Your Review Here..."
                                                                  class="form-control" id="review" name="message" ></textarea>
                                                    ...
                                                    <div class="comment-body">
                                                        ...
                                                        <div class="comment-content">
                                                            <h4 class="comment-author">
                                                                ...
                                                                <span class="comment-date"> {{date('F d, Y', strtotime($review->created_at))}} at {{date('h:i a',strtotime($review->created_at))}} </span>
                                                            </h4>
                                        ...
                                        <div class="product-pa-wrapper">
                                            <div class="product-price">
                                                @if ($product->off_date_start <= date('Y-m-d') && $product->off_date_end >= date('Y-m-d'))
                                                    ...
                                                    <div style="font-width: bold; font-size:15px">
                                                        Discount :
                                                        <span style="color: rgb(3, 68, 12); font-weight:bold">
                                                           {{round((100 * ($product->price - $product->off_price)) / $product->price)}}
                                                            %
